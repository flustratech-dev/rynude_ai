            ...
            <div class="w-full lg:w-1/2 flex flex-col items-center justify-center pt-10 lg:pt-0">
                ...
                <div class="w-full max-w-[360px] bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden relative">
                    ...
                    <div class="bg-gradient-to-r from-[#EBF2FF] to-[#F2EFFF] py-3 px-4 text-center border-b border-gray-100">
                        ...
                        <span class="text-[13px] text-gray-700 font-medium">rynude Design: available for Pro and Max plans</span>
                    </div>
                    ...
                    <div class="p-6">
                        <button type="button" class="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-200 rounded-2xl hover:bg-gray-50 transition-colors mb-6 shadow-sm">
                            ...
                            <span class="text-[15px] font-medium text-[#2D2825]">Continue with Google</span>
                        </button>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            @csrf
                            <div class="mb-3">
                                <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="Enter your email" class="w-full px-4 py-2.5 rounded-2xl border border-gray-200 text-[14px] text-[#2D2825] placeholder-gray-400 focus:outline-none focus:border-[#2D2825] focus:ring-1 focus:ring-[#2D2825] transition-all shadow-sm" required autofocus>
                        ...
                        <p class="text-[11px] text-gray-400 text-center mt-6">
                            By continuing, you acknowledge rynude's <a href="#" class="underline hover:text-gray-600">Privacy Policy</a>.
                        </p>
