        ...
        <div x-show="tab==='keys'" x-transition>
            <div class="bg-[#F9F8F6] dark:bg-claude-bg-dark rounded-xl border border-claude-border-light dark:border-claude-border-dark p-6">
                ...
                <div class="space-y-4">
                    ...
                    {{-- Model Hub (GGUF Local AI Engine) --}}
                    <div class="p-4 rounded-lg border border-claude-border-light dark:border-claude-border-dark bg-[#F5F4F0]/50 dark:bg-[#2C2C2A]/50">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-lg bg-[#D97757]/10 dark:bg-[#D97757]/20 flex items-center justify-center text-[#D97757] font-bold text-sm">
                                ...
                                <div><h3 class="text-[14px] font-medium text-[#2D2825] dark:text-stone-200">Model Hub (GGUF Local AI Engine)</h3><p class="text-[12px] text-gray-500 dark:text-stone-400">Unduh & kelola model lokal (Qwen, Llama, Mistral) tanpa terminal</p></div>
                            </div>
                            <a href="{{ route('model-hub') }}" class="px-3.5 py-2 text-xs text-white bg-[#D97757] hover:bg-[#c96646] rounded-lg font-medium transition-colors shadow-sm flex items-center gap-1.5">
                                <span>Buka Model Hub</span>
