...
<div class="relative mb-6">
    ...
    >
                ...
                <div class="space-y-2">
                    ...
                    <div x-show="filteredModels.length===0" class="text-center py-12 flex flex-col items-center">
                        <div class="w-16 h-16 rounded-full bg-gray-100 dark:bg-stone-800 flex items-center justify-center mb-4">
                            <svg class="w-8 h-8 text-gray-400 dark:text-stone-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607zM10.5 7.5v6m3-3h-6"/></svg>
                        </div>
...
function apiKeysPage(){
    return {
        ...
        get filteredModels(){
            ...
            if(this.filter !== 'all'){
                list = list.filter(m=>m.provider===this.filter);
            }
        ...
        saveModel(){
            ...
            fetch('/api/settings',{
                ...
                body:JSON.stringify({_action:'store_model',model_id:this.dlgEditId,model_code:this.dlgCode.trim(),model_name:this.dlgName.trim(),model_provider:this.dlgProv,model_is_active:this.dlgActive})
            })
