...
<div id="chat-interface-root" class="flex flex-col h-full min-h-0 w-full bg-transparent dark:bg-claude-bg-dark relative overflow-hidden"
    ...
    <style>
        ...
        /* Force AI response and user message text colors to match exactly in dark mode */
        .dark .font-claude-response p,
        .dark .font-claude-response li,
        .dark .font-claude-response ol,
        .dark .font-claude-response ul,
        .dark .font-claude-response strong,
        .dark .user-message-text {
            color: #d6d3d1 !important; /* stone-300 - soft off-white */
        }
    </style>
            ...
            <div class="flex-1 min-h-0 overflow-y-auto custom-scrollbar" x-ref="messagesContainer" id="chat-scroll-container">
                <div class="mx-auto w-full pt-4 md:pt-6 pb-12 md:pb-20 px-3 md:px-4" style="max-width: 880px;">
                    <div class="space-y-1">
                                    ...
                                    <div class="flex justify-end w-full">
                                        <div class="flex flex-col items-end gap-2 max-w-[85%] md:max-w-[75%]">
                                            ...
                                            <template x-if="msg.content && editingIdx !== idx">
                                                <div class="bg-stone-100 dark:bg-[#3A3A38] border border-transparent text-stone-900 dark:text-stone-300 user-message-text px-4 py-2.5 rounded-xl text-[15px] leading-relaxed break-words whitespace-pre-wrap w-full" x-text="msg.content"></div>
                                             </template>
                        ...
                        {{-- Streaming indicator --}}
                        <div x-show="streaming || (streamContent && streamContent !== '')" x-cloak class="flex justify-start w-full gap-3 md:gap-4 mt-1">
                            <div x-show="streaming" class="flex-shrink-0 mt-1">
                            ...
                            <div x-show="!streaming && streamContent" class="flex-shrink-0 mt-1">
                                <svg class="w-6 h-6 md:w-7 md:h-7 text-red-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                            </div>
                            <div class="flex-1 min-w-0">
