...
>
    ...
    <div x-show="open" x-cloak class="h-full w-full flex-1 min-h-0 flex flex-col" x-data="{ searchOpen: false, searchQuery: '' }">
        ...
        <div class="flex-1 min-h-0 overflow-y-auto custom-scrollbar px-2">
            ...
            <div x-data="{ addApiOpen: true }" class="w-full">
                <div class="flex items-center justify-between px-2 py-1.5 rounded-lg hover:bg-[#EAE9E5]/60 dark:hover:bg-[#3A3A38] transition-all duration-200 group">
                    <a href="{{ route('api-keys') }}" class="flex items-center gap-2.5 text-[13px] text-[#2D2825] dark:text-stone-300 font-medium flex-1">
                        <svg class="w-[18px] h-[18px] flex-shrink-0 dark:text-stone-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                    ...
                    <button @click.prevent="addApiOpen = !addApiOpen" class="p-0.5 text-gray-400 hover:text-gray-600 dark:hover:text-stone-200 rounded">
                        <svg class="w-3.5 h-3.5 transition-transform duration-200" :class="addApiOpen ? 'rotate-90' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
                    </button>
                </div>
                
                <div x-show="addApiOpen" x-collapse.duration.200ms class="pl-6 pr-1 space-y-0.5 mt-0.5">
                    <a
                        href="{{ route('model-hub') }}"
                        class="sidebar-menu-item w-full flex items-center justify-between py-1 px-2 rounded-lg text-[12px] transition-all duration-200 text-gray-600 dark:text-stone-400 hover:text-[#2D2825] dark:hover:text-stone-200 hover:bg-[#EAE9E5]/60 dark:hover:bg-[#3A3A38] group"
                    >
                        <div class="flex items-center gap-2">
                            <svg class="w-3.5 h-3.5 text-[#D97757]" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
            ...
            @auth
                <div x-data="{ profileMenuOpen: false }">
                    <div
                        ...
                        style="display: none;"
                    >
                        <div class="text-[12px] text-gray-500 dark:text-stone-400 font-medium px-2.5 py-1 mb-0">
                            {{ auth()->user()->email }}
                        </div>
                        <button
                            @click="profileMenuOpen = false; window.dispatchEvent(new CustomEvent('open-settings-ui', { detail: 'general' }));"
                            class="flex items-center justify-between w-full px-2.5 py-1.5 text-[13px] text-gray-700 dark:text-stone-300 hover:bg-[#F9F8F6] dark:hover:bg-[#3A3A38] cursor-pointer transition-colors"
                        >
                            <span class="flex items-center gap-1.5">
                                <svg class="w-3.5 h-3.5 text-gray-500 dark:text-stone-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                            ...
                            <span class="text-[11px] text-gray-400 font-light">Ctrl ⇧ ,</span>
                        </button>
                        <div x-data="{ languageOpen: false, currentLang: localStorage.getItem('rynude_lang') || 'English' }" class="relative">
                            ...
                            >
                                ...
                                <span class="flex items-center gap-1.5">
                                    <span class="text-[11px] text-gray-400 dark:text-stone-500" x-text="currentLang"></span>
                            ...
                            >
                                <template x-for="lang in ['English', 'Bahasa Indonesia']" :key="lang">
                                    <button
                                        ...
                                        class="flex items-center justify-between w-full px-2 py-1.5 text-[13px] text-gray-600 dark:text-stone-300 hover:bg-[#F3F3F3] dark:hover:bg-[#3A3A38] rounded-md transition-colors"
                                    >
                                        <span x-text="lang"></span>
                                        <svg x-show="currentLang === lang" class="w-3.5 h-3.5 text-[#D97757]" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
                                    </button>
                                </template>
                            </div>
                        </div>
                        ...
                        >
                            <span class="flex items-center gap-1.5">
                                <svg class="w-3.5 h-3.5 text-blue-500 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                        ...
                        <div x-data="{ learnMoreOpen: false }" class="relative">
                            ...
                            <div
                                ...
                                class="pl-7 pr-3 pb-0.5 space-y-[1px]"
                            >
                                <a href="https://docs.anthropic.com" target="_blank" rel="noopener" class="flex items-center gap-1.5 px-2 py-1 text-[12px] text-gray-600 dark:text-stone-300 hover:bg-[#F3F3F3] dark:hover:bg-[#3A3A38] rounded-md transition-colors">
                                ...
                                <a href="https://anthropic.com/blog" target="_blank" rel="noopener" class="flex items-center gap-1.5 px-2 py-1 text-[12px] text-gray-600 dark:text-stone-300 hover:bg-[#F3F3F3] dark:hover:bg-[#3A3A38] rounded-md transition-colors">
                                    <svg class="w-3.5 h-3.5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                ...
                                <a href="https://status.anthropic.com" target="_blank" rel="noopener" class="flex items-center gap-1.5 px-2 py-1 text-[12px] text-gray-600 dark:text-stone-300 hover:bg-[#F3F3F3] dark:hover:bg-[#3A3A38] rounded-md transition-colors">
                                    <svg class="w-3.5 h-3.5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="flex items-center justify-between w-full px-2.5 py-1.5 text-[13px] text-gray-700 hover:bg-[#F9F8F6] cursor-pointer transition-colors">
                                <span class="flex items-center gap-1.5">
    ...
    <div x-show="!open" x-cloak class="h-full w-full flex-1 min-h-0 flex flex-col items-center py-4 px-2 gap-1 bg-[#F9F8F6] dark:bg-claude-bg-dark overflow-y-auto custom-scrollbar">
        ...
        <a
            href="{{ route('api-keys') }}"
            class="p-2 rounded-lg transition-colors w-full flex items-center justify-center text-gray-500 dark:text-stone-200 hover:bg-[#EAE9E5]/60 dark:hover:bg-stone-800/50 hover:text-[#2D2825] dark:hover:text-stone-200"
            title="Add API"
        >
            <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
        ...
        <a
            href="{{ route('code') }}"
            class="p-2 rounded-lg transition-colors w-full flex items-center justify-center text-gray-500 dark:text-stone-200 hover:bg-[#EAE9E5]/60 dark:hover:bg-stone-800/50 hover:text-[#2D2825] dark:hover:text-stone-200 group"
            title="Code"
        >
            <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                <path class="code-bracket-right" stroke-linecap="round" stroke-linejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25"/>
        ...
        @else
            <a href="{{ route('login') }}" class="p-2 rounded-lg hover:bg-[#EAE9E5]/60 dark:hover:bg-stone-800/50 transition-colors text-gray-500 dark:text-stone-200 hover:text-[#2D2825] dark:hover:text-stone-200 w-full flex items-center justify-center mb-2" title="Log in">
                <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9"/>
                </svg>
            </a>
