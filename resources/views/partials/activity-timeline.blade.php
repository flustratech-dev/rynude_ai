...
class="flex flex-col font-sans px-4 py-4 mb-4 rounded-xl border border-stone-200 dark:border-stone-700 bg-[#FAFAFA] dark:bg-[#3A3A38] shadow-sm"
>
    ...
    <div class="relative pl-1">
        ...
        <template x-for="(stage, index) in stages" :key="stage.id">
            <div class="relative flex items-start gap-3 mb-3 last:mb-0">
                <div class="relative z-10 shrink-0 mt-0.5 bg-[#FAFAFA] dark:bg-[#3A3A38] rounded-full py-0.5">
                    ...
                    <template x-if="stage.status === 'running'">
                        <div class="w-4 h-4 flex items-center justify-center bg-[#FAFAFA] dark:bg-[#3A3A38]">
                    ...
                    <template x-if="stage.status === 'completed'">
                        <div class="w-4 h-4 rounded-full bg-green-500 flex items-center justify-center text-white ring-[3px] ring-[#FAFAFA] dark:ring-[#3A3A38]">
                    ...
                    <template x-if="stage.status === 'error'">
                        <div class="w-4 h-4 rounded-full bg-red-500 flex items-center justify-center text-white ring-[3px] ring-[#FAFAFA] dark:ring-[#3A3A38]">
