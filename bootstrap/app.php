...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        // Exclude API routes from CSRF so the browser extension and stateless
        // REST clients can call the API surface. The routes are still protected
        // by the web middleware's session auth.
