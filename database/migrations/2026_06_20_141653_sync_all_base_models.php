...
return new class extends Migration
{
    public function up(): void
    {
        $models = [
            ...
            ['code' => 'claude-opus-4-7', 'name' => 'Rynude Opus 4.7'],
            ['code' => 'claude-opus-4-6', 'name' => 'Rynude Opus 4.6'],
            ['code' => 'claude-sonnet-4-6', 'name' => 'Rynude Sonnet 4.6'],
            ['code' => 'claude-opus-4-5', 'name' => 'Rynude Opus 4.5'],
            ['code' => 'claude-sonnet-4-5', 'name' => 'Rynude Sonnet 4.5'],
            ['code' => 'claude-haiku-4-5', 'name' => 'Rynude Haiku 4.5'],
