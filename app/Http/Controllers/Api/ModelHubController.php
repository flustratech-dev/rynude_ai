...
class ModelHubController extends Controller
{
    ...
    private function getCatalog(): array
    {
        return [
            ...
            [
                'id' => 'rynude-lyric-plus-3',
                'name' => 'rynude Lyric 4.8',
                'description' => 'Upgrade dari Lyric 4.7: dilatih ulang (LoRA) di atas dataset 4.8 dengan perbaikan penyusunan skripsi — dokumen hanya memuat bab yang diminta dan lengkap semua sub-bab, penjelasan bab lanjutan di chat, serta "lanjutkan BAB" menambah ke dokumen yang sama. Mewarisi kepatuhan artifact + front-matter dan anti-halusinasi 4.7. Kuantisasi Q8_0, ringan.',
                'parameter_size' => '1.7B (LoRA)',
                'required_ram_gb' => 4.0,
                'file_size_label' => '1.83 GB',
                'file_size_bytes' => 1834426048,
                'filename' => 'rynude-lyric-4.8.gguf',
                'download_url' => 'https://huggingface.co/flustratechcompany/rynude-lyric-4.8/resolve/main/rynude-lyric-4.8.gguf',
                'recommended' => true,
                'recommended_for' => ['low', 'medium', 'high'],
            ],
            [
                'id' => 'llama-3.2-3b',
                'name' => 'rynude Stanza 4.5',
                'description' => 'Arsitektur rynude-v3 Mid-Scale (basis Qwen3-4B, tanpa fine-tune). Kualitas pemahaman setara model kelas atas — sangat efisien dan akurat untuk analisis dokumen, penalaran logis, serta asisten coding tingkat menengah.',
                'parameter_size' => '4B',
                'required_ram_gb' => 6.0,
            ...
            [
                'id' => 'rynude-stanza-plus-1',
                'name' => 'rynude Stanza 4.6',
                'description' => 'Fine-tune skripsi (QLoRA) di atas Stanza 4.5. Dataset dibersihkan dari contoh placeholder/kerangka kosong — model menulis bab yang diminta sampai lengkap (bukan "(Isi bagian ini…)"), tetap on-topic, dan proses berpikir dipertahankan. Model 4B untuk penyusunan skripsi paling rapi di antara model lokal. Kuantisasi Q4_K_M, muat 8 GB VRAM pada konteks 32K.',
                'parameter_size' => '4B (LoRA)',
                'required_ram_gb' => 6.0,
                'file_size_label' => '2.5 GB',
                'file_size_bytes' => 2497280288,
                'filename' => 'rynude-stanza-4.6.gguf',
                'download_url' => 'https://huggingface.co/flustratechcompany/rynude-stanza-4.6/resolve/main/rynude-stanza-4.6.gguf',
                'recommended' => true,
                'recommended_for' => ['low', 'medium', 'high'],
            ],
            [
