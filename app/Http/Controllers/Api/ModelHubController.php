    ...
    private function getCatalog(): array
    {
        return [
            ...
            [
                'id' => 'qwen-2.5-1.5b',
                'name' => 'rynude Lyric',
                'description' => 'Rekomendasi untuk sebagian besar pengguna: keseimbangan terbaik antara kecepatan, kecerdasan, dan kualitas dokumen pada komputer spesifikasi terbatas.',
                'parameter_size' => '1.5B',
                'required_ram_gb' => 4.0,
            ...
            [
                'id' => 'llama-3.2-3b',
                'name' => 'rynude Stanza',
                'description' => 'Model generasi terbaru yang sangat efisien untuk asisten coding ringan dan rangkuman dokumen.',
                'parameter_size' => '3B',
                'required_ram_gb' => 6.0,
